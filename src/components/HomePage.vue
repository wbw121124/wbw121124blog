...
const PostList = defineAsyncComponent(() => import('./PostList.vue'));
</script>

<template>
	<main class="component XiaolaiMono">
		...
		<div class="mkd acsii-art"
			...
			<pre class="text-primary" style="line-height: 1.25 !important; overflow-x: auto !important;"><code style="font-size: 12px !important;line-height: 1.25 !important;font-weight: 700; width: max-content; font-family: 'Courier New', Courier, monospace;">           _               _  ____   _  _  ____   _  _    _      _               
__      __| |__ __      __/ ||___ \ / |/ ||___ \ | || |  | |__  | |  ___    __ _ 
\ \ /\ / /| '_ \\ \ /\ / /| |  __) || || |  __) || || |_ | '_ \ | | / _ \  / _` |
 \ V  V / | |_) |\ V  V / | | / __/ | || | / __/ |__   _|| |_) || || (_) || (_| |
  \_/\_/  |_.__/  \_/\_/  |_||_____||_||_||_____|   |_|  |_.__/ |_| \___/  \__, |
                                                                           |___/ </code></pre>
		</div>
	</main>
